    ...
    <>
      ...
      <View style={[styles.settingsCard, { backgroundColor: theme.colors.surface }]}>
        <View style={styles.settingRow}>
          ...
          <Switch value={enabled} onValueChange={onToggle} color={theme.colors.primary} />
        </View>
          ...
          <>
            ...
            <View style={styles.quietHoursRow}>
              <View style={styles.quietHoursItem}>
                ...
                <Pressable style={[styles.timeButton, { backgroundColor: theme.colors.surfaceVariant }]}>
                  <MaterialCommunityIcons
                    name="clock-outline"
                    size={18}
                    color={theme.colors.onSurfaceVariant}
                  />
                  <Text style={[styles.timeText, { color: theme.colors.onSurface }]}>{startTime}</Text>
                </Pressable>
              </View>
              <MaterialCommunityIcons
                name="arrow-right"
              ...
              <View style={styles.quietHoursItem}>
                ...
                <Pressable style={[styles.timeButton, { backgroundColor: theme.colors.surfaceVariant }]}>
                  <MaterialCommunityIcons
                    ...
                    color={theme.colors.onSurfaceVariant}
                  />
                  <Text style={[styles.timeText, { color: theme.colors.onSurface }]}>{endTime}</Text>
                </Pressable>
              </View>
            </View>
          </>
  ...
  return (
    <View style={[styles.infoCard, { backgroundColor: '#FFF3E0' }]}>
      ...
      <Text style={styles.infoText}>
        Push notifications require permission from your device settings. Make sure notifications are enabled for JeepneyGo.
      </Text>
    </View>
  );
}
  ...
  return [
    {
      ...
      iconBg: '#E3F2FD',
      title: 'ETA Alerts',
      description: 'Get notified when your jeepney is arriving',
      enabled: true,
    },
    {
      id: 'favorite-stops',
      ...
      iconColor: '#E91E63',
      iconBg: '#FCE4EC',
      title: 'Favorite Stop Updates',
      description: 'Alerts for jeepneys near your saved stops',
      enabled: true,
    },
    {
      id: 'route-updates',
      ...
      iconBg: '#E8F5E9',
      title: 'Route Updates',
      description: 'Changes to routes or schedules',
      enabled: true,
    },
    {
      id: 'traffic-alerts',
      ...
      description: 'Congestion and delay notifications',
      enabled: false,
    },
    {
      id: 'promo-updates',
